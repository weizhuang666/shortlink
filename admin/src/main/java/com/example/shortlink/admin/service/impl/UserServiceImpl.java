...
import static com.example.shortlink.admin.common.enums.UserErrorCodeEnum.USER_NAME_EXIST;
import static com.example.shortlink.admin.common.enums.UserErrorCodeEnum.USER_SAVE_ERROR;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, UserDO> implements UserService {
    ...
    public UserRespDTO getUserByUserName(String username) {
        ...
        if (userDO == null){
            throw new ClientException(UserErrorCodeEnum.USER_NOT_NULL);
        }
